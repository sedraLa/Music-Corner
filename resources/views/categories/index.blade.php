        ...
        <div class="cards">
            @forelse ($category->products as $product)
                ...
                <div class="card">
                    ...
                    <a href="">
                        <h5 class="destination-title">{{ $product->name }}</h5>
                    ...
                    <div class="manage-btn flex items-center gap-3 mt-3 mb-3 px-4">
                        <button class="add-cart-btn px-4 py-2 rounded-xl text-white bg-blue-600 hover:bg-blue-700 transition duration-200 text-sm shadow-sm"
                                data-id="{{ $product->id }}">
                            Add to cart
                        </button>
                    </div>
